...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        <header class="topbar" style="background: linear-gradient(to left, #33ccff 0%, #ff99cc 100%);;">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header" style="background: linear-gradient(to right, #33ccff 0%, #ff99cc 100%);">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/hricn.png" alt="DRI" class="DRI-logo img-thumbnail" style="width:80px;"/>
                        </b>
                        <!-- Logo text --><span>
                         <img src="<?php echo base_url(); ?>assets/images/<?php echo $settingsvalue->sitelogo; ?>" alt="homepage" class="dark-logo img-thumbnail" height="90px" width="150px" />
                         <!-- Light Logo text -->    
                         </span> </a>
                </div>
                <div class="navbar-collapse">
                    <ul class="navbar-nav mr-auto mt-md-0">                        
                        ...
                        <h1 style="text-align:justify; color: hotpink; font-family: serif; text-shadow: 2px 2px 5px blue;"><strong>PRIMEWORK HRMS</strong></h1>
                    </ul> 
                    <nav class="navbar navbar-expand-lg navbar-dark justify-content-center">
                        <span class="navbar-text mb-0" style="color:red;">
                                Your job is my job||primework@hrms.co.ke
                        </span>
                    </nav>               
